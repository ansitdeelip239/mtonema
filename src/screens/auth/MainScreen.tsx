    ...
    return (
      <View style={styles.mainScreen}>
        ...
        <View style={styles.lowerPart}>
          ...
          <TouchableOpacity style={[styles.button, styles.spacing]} onPress={onLogin}>
            <Text style={styles.buttonText}>Log In</Text>
          </TouchableOpacity>
    
          <Text style={styles.promptText}>New Here? Create an Account!</Text>
          <TouchableOpacity style={[styles.button, styles.spacing]} onPress={onSignup}>
            <Text style={styles.buttonText}>Sign Up</Text>
          </TouchableOpacity>
  
          <TouchableOpacity style={[styles.listPropertyText, styles.spacing]} onPress={onListProperty}>
